...
{
    public class ScrollDown1 : IRelativeGestureSegment
    {
    ...
    public class ScrollDown2 : IRelativeGestureSegment
    {
        public GesturePartResult CheckGesture(Skeleton skeleton)
        {
            // hand above shoulder
    ...
    public class ScrollDown3 : IRelativeGestureSegment
    {
        public GesturePartResult CheckGesture(Skeleton skeleton)
        {
            // hand above shoulder
    ...
    public class ScrollDown4 : IRelativeGestureSegment
    {
        public GesturePartResult CheckGesture(Skeleton skeleton)
        {
            // hand above shoulder
